        ...
        <tbody>
          {holdings.map((h) => (
            <tr key={`${h.rank}-${h.assetName}`} className="hover:bg-muted/30 border-b">
              ...
              <td className="max-w-[160px] truncate px-2 py-2 font-medium">{h.assetName}</td>
              ...
              <td className="text-muted-foreground hidden px-2 py-2 text-xs md:table-cell capitalize">
                {h.assetType}
              </td>
