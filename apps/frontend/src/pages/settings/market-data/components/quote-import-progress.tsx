    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t("marketData.importProgress")}
        </CardTitle>
        <CardDescription>
          {isImporting ? t("marketData.importingQuotes") : t("marketData.importCompleted")}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span>{t("marketData.progress")}</span>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            ...
            <div className="text-muted-foreground text-sm">{t("marketData.total")}</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{successfulRows}</div>
            <div className="text-muted-foreground text-sm">{t("marketData.successful")}</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-red-600">{failedRows}</div>
            <div className="text-muted-foreground text-sm">{t("marketData.failed")}</div>
          </div>
        </div>
